...
export function RiwayatDetailSheet({
  ...
  return (
    <>
      ...
      {/* Di luar Sheet, bukan di dalamnya: SheetContent memakai position fixed
          dan transform, sehingga `position: absolute` milik nota akan mengukur
          diri terhadap panel itu — bukan terhadap halaman — dan cetakannya
          terpotong. */}
